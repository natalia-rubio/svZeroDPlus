...
#include "DirDepJunction.h"

void DirDepJunction::setup_dofs(DOFHandler& dofhandler) {
...
void DirDepJunction::update_constant(SparseSystem& system,
...
void DirDepJunction::update_solution(
...
void DirDepJunction::update_gradient(
