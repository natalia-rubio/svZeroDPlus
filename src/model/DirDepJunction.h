...
/**
 * @file DirDepJunction.h
 * @brief model::DirDepJunction source file
 */
#ifndef SVZERODSOLVER_MODEL_DIRDEPJUNCTION_HPP_
#define SVZERODSOLVER_MODEL_DIRDEPJUNCTION_HPP_
 ...
 *
 */
class DirDepJunction : public Block {
 public:
  /**
   * @brief Construct a new DirDepJunction object
   *
   * @param id Global ID of the block
   * @param model The model to which the block belongs
   */
  DirDepJunction(int id, Model* model)
      : Block(id, model, BlockType::dir_dep_junction, BlockClass::junction,
...
#endif  // SVZERODSOLVER_MODEL_DIRDEPJUNCTION_HPP_
