...
/**
 * @file DirIndepJunction.h
 * @brief model::DirIndepJunction source file
 */
#ifndef SVZERODSOLVER_MODEL_DIRINDEPJUNCTION_HPP_
#define SVZERODSOLVER_MODEL_DIRINDEPJUNCTION_HPP_
 ...
 *             ],
 *             "junction_name": "J0",
 *             "junction_type": "DirIndepJunction",
 *             "junction_values": {
 *                 "R_poiseuille": [
 *                     100,
 *                     200
 ...
 *
 */
class DirIndepJunction : public Block {
 public:
  /**
   * @brief Construct a new DirIndepJunction object
   *
   * @param id Global ID of the block
   * @param model The model to which the block belongs
   */
  DirIndepJunction(int id, Model* model)
      : Block(id, model, BlockType::dir_indep_junction, BlockClass::junction,
...
#endif  // SVZERODSOLVER_MODEL_DIRINDEPJUNCTION_HPP_
