...
/**
 * @file HybridJunction.h
 * @brief model::HybridJunction source file
 */
#ifndef SVZERODSOLVER_MODEL_HYBRIDJUNCTION_HPP_
#define SVZERODSOLVER_MODEL_HYBRIDJUNCTION_HPP_
 ...
 * * `i+3*num_outlets` Pressure recovery coefficient for inner blood vessel `i`
 *
 ...
 *
 */
class HybridJunction : public Block {
 public:
  /**
   * @brief Construct a new HybridJunction object
   *
   * @param id Global ID of the block
   * @param model The model to which the block belongs
   */
  HybridJunction(int id, Model* model)
      : Block(id, model, BlockType::hybrid_junction, BlockClass::junction,
              {{"R_poiseuille", InputParameter()},
               {"L", InputParameter()},
               {"stenosis_coefficient", InputParameter()},
               {"pressure_recovery_coefficient", InputParameter()}}) {
...
#endif  // SVZERODSOLVER_MODEL_HYBRIDJUNCTION_HPP_
